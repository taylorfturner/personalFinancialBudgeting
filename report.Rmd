...
#heatmap calendar for transactions 
#want to add week number of the month in place of the `day` in `aes()`
#decay$week <- as.numeric(format(as.Date(decay$date),"%W"))
#ggplot(decay, aes(day, weekday, fill = DEBIT)) + geom_tile(colour = "white") + facet_grid(YEAR~month) + scale_fill_gradient(low="red", high="yellow")
```
