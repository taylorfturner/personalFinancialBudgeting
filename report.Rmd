...
for (tbl in tbls){
  if(tbl == "R_MARGIN_VIEW"){
    ...
    sumar <- sumar %>% mutate(
      flg = as.factor(ifelse(sumar$MARGIN < 0, 'X<$0', ifelse(sumar$MARGIN > 0 & sumar$MARGIN < 1000, '$0<X<$1000', ifelse(sumar$MARGIN > 1000 & sumar$MARGIN < 1500,'$1000<X$1500', ifelse(sumar$MARGIN > 1500 & sumar$MARGIN < 1750, '$1500<X$1750', ifelse(sumar$MARGIN > 1750 & sumar$MARGIN < 2000, '$1750<X$2000','$2000<X')))))), 
    ...
    decay <- decay %>%
      ...
      mutate(
        ...
        marg_flg  = as.factor(
          ...
          ifelse((mnthtot < 2000 & mnthtot > 1750), "1750<X<2000", "2000<X")))))),
