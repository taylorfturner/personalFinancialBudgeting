...
plot <- ggplot() + geom_point(data = food, aes(x = dynm, y = perDiem, color = c("budget"))) + geom_point(data = food, aes(x = dynm, y = (sumTrans * -1), color = c("trans"))) + ggtitle("Daily Food Margin") + xlab("Day Number") + ylab("Daily Spend")
